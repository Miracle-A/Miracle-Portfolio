...
function ContactMe({}: Props) {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      <h3 className="absolute top-20 se:top-24 md:top-20 uppercase tracking-[12px] sm:tracking-[20px] text-gray-500 text-xl md:text-2xl">
        Contact
      </h3>

      <div className="flex flex-col gap-4 se:gap-[30px] sm:space-y-10">
        <h4 className="text-[17px] se:text-[20px] sm:text-3xl md:text-4xl font-semibold text-center p-0 mt-16 se:mt-0">
        ...
        <div className="space-y-2 sm:space-y-7 md:space-y-10">
          <div className="flex items-center space-x-3 sm:space-x-5 justify-center">
            ...
            <p className="text-[16px] se:text-lg md:text-2xl">+1281876****</p>
          </div>

          <div className="flex items-center space-x-3 sm:space-x-5 justify-center">
            <EnvelopeIcon className="text-[#F7AB0A] h-5 w-5 sm:h-7 sm:w-7 animate-pulse" />
            <p className="text-[16px] se:text-lg md:text-2xl">
