  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        className="xs:mt-36 se:mt-32 sm:mt-20 mb-0 md:-mb-1 flex-shrink-0  object-cover rounded-full sm:rounded-lg w-[200px] h-[200px] se:w-[230px] se:h-[230px] sm:w-[300px] sm:h-[400px] md:w-[350px] md:h-[450px] lg:w-[400px] lg:h-[600px] xl:w-[560px] xl:h-[660px]"
      />
